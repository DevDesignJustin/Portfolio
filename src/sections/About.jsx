const About = () => {
  return (
    <section className="about mt-[120px]" id="about">
      <div className="container">
        ...
        <div className="about-item col-span-1 ">
          ...
          <p className="about-text">
            ...
            games, fishing, playing sports, trying new foods, video editing and
        ...
        <div className="about-item col-span-2 pl-8">
          ...
          <p className="about-text">
            I like to play a variety of different sports, and among them I enjoy
            skiing and table tennis the most. I play table tennis on a
            international level, competing is places like Chile. I also love
            skiing with family and friends, which is one of the best things ever,
            but we can’t ski all year round. :(
          </p>
        </div>
